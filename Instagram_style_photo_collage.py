...
img1 = cv2.imread("Images\\bottom_left.jpg")
if img1 is not None:
    imbl = cv2.cvtColor(img1,cv2.COLOR_BGR2RGB)
    bottom_left = cv2.resize(imbl, (200, 200))
img2 = cv2.imread("Images\\bottom_right.jpg")
...
img3 = cv2.imread("Images\\center.jpeg")
...
img4 = cv2.imread("Images\\top_left.jpg")
...
img5 = cv2.imread("Images\\top_right.jpg")
